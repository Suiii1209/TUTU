...
TOKEN = '7304967887:AAH75yGbhNsjkCFJ8UohakK2FrpBLRJB2dI'
...
FORWARD_CHANNEL_ID = -1002219283745
CHANNEL_ID = -1002219283745
error_channel_id = -1002219283745
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.reply_to(message, "*Contact admin @KRATOS89*", parse_mode='Markdown')
    else:
